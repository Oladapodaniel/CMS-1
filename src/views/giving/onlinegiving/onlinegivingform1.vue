  ...
  <div class="bg">
    ...
    <section>
      <div class="container-fluid">
        ...
        <div class="row mt-n5">
          <div class="col-4 offset-5 mt-n5 text-nowrap">
            <div class="mt-n5 text-center text-sm-center position-absolute txt">
              <p class="givep mt-n3">GIVING</p>
              <p class="text-white mt-n2">Give and you shall recieve</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div class="col-md-4 offset-md-4">
          <div class="row mild shadow p-3 mb-5 bg-body rounded">
            ...
            <section class="col-10 offset-1 mt-3 px-0" v-if="hideTabOne">
              <div class="row">
                ...
                <div class="col-md-6 d-flex flex-row mt-n2">
                  <input type="date" class="form-control fone" v-model="date" />
                </div>
              </div>
            </section>
            ...
            >
              <div class="row">
                <p class="col-6 py-0 ml-1 hfont">Fund</p>
                <div class="col-12 d-flex flex-row mt-n2">
                  <Dropdown
                    class="fone w-100 p-0"
              ...
              <div class="row">
                <div class="col-md-12 text-center mt-2 pin">
    ...
    <div class="container footer-area">
      <div class="row">
        ...
        <div class="col-md-5 col-sm-12 fone text-nowrap mig">
          <p class="text-nowrap">
            Churchplus <span><u>Terms & Conditions</u></span
            >and
            <span><u>Privacy Policy</u> </span>
          </p>
          <p class="mt-n2 text-nowrap">
          ...
          <hr class="mt-n3" />
          <img
            class="col-8 mb-5 ml-n3 logo img-fluid"
            src="../../../assets/churchplus-logo.png"
            alt=""
          />
        </div>
      </div>
