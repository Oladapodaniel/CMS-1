<template>
    <div>
        <div class="container">
            <div class="row">
                <div class="mt-5 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-sm-center">
                ...
                <div class="col-lg-2 col-md-5 mb-md-4 mb-sm-4 mb-xl-0 mb-lg-0 mb-4 box1">
                    <div class="row mt-3 mb-5">
                        <div class="col-md-6 text-sm-center text-center">
                         ...
                         <div class="col-md-6 per text-sm-center text-center">
                             +1%
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-5 col-md-8 time1 text-lg-center text-sm-center text-center">
            ...
            <div class="row mt-4">
                ...
                /> -->
                    ...
                    <div class="row d-lg-flex d-md-flex d-flex justify-content-between justify-content-md-between justify-content-lg-around">
             ...
             <div class="row d-flex justify-content-between mt-5 mb-5">
                <div class="col-md-3 like px-4 py-4 mb-sm-4 mb-lg-0 mb-md-0 mb-xl-0 mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-12 text-lg-center num mt-3 text-sm-center text-center">
                            <h3>2445</h3>
                        </div>
