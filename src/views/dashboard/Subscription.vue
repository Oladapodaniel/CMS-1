<template>
  <div class="mainCont">
    <div class="container  ">
      <div class="row mt-3">
        <div class="col-md-7 col-lg-7  mx-2  ">
          <div
            class="py-3 font-weight-bold text-left"
            style="color: #02172E, opacity:1, font: normal normal 800 34px/46px Nunito Sans;"
          >
            Subscription
          </div>
          <div class="row bg-white sub  rounded  pb-2">
            <div class="col-md-6 col-lg-6  col-12">
              <div class="py-2">Subscription type</div>
              <Dropdown
        ...
        <div class="col-md-4 col-lg-4 mx-2  ml-3-col-12 ">
          <div class="py-3 font-weight-bold">Current plan</div>
          <div class="row bg-white rounded pb-2">
            <div class="">
              <div class="col-12 col-md-4 col-lg-4 col-xl-4">
                <h3>{{ currentPlan }}</h3>
              </div>
              <div class="col-12 col-md-4 col-lg-4 col-xl-4">Date</div>
            </div>
          </div>
        </div>
        <!-- Add ons -->
        <div class="col-md-12 col-lg-12 pt-3 ">ADD-ONS</div>

        <div class="col-md-7 col-lg-7 mx-2  rounded mt-3 bg-white">
          <div class="communication">
            <div class="ml-2">
              <div class="my-3 font-weight-bold ">Communication</div>
              <div class="row">
        ...
        <!-- payment summary -->
        <div
          class="col-md-4 mx-2  bg-white col-lg-4 ml-3-col-12 payment  mt-3 "
        >
...
<style scoped>
.mainCont {
  background: #e6f1ff57 0% 0% no-repeat padding-box;
  opacity: 1;
  width: 190vh;
  height: 100vh;
}
